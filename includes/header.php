...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success">
        <div class="container">
            <a class="navbar-brand logo-hover" href="/index.php" title="Ir a Home">
                ActivaTuJuego
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarContenido">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php else: ?>
                        <li class="nav-item"><a class="nav-link" href="/views/login.php">Iniciar Sesión</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="/views/register.php">Registrarse</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </div>
