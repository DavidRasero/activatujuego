                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text mb-1"><strong>Organizador:</strong> <?= htmlspecialchars($row['organizador']) ?></p>
                                <p class="card-text mb-1"><strong>Centro:</strong> <?= htmlspecialchars($row['centro']) ?></p>
                                <p class="card-text mb-1"><strong>Dirección:</strong> <?= htmlspecialchars($row['direccion']) ?></p>
                                <p class="card-text mb-1"><strong>Fecha:</strong> <?= date('d/m/Y H:i', strtotime($row['fecha'])) ?></p>
                                <p class="card-text mb-1"><strong>Jugadores:</strong> <?= $row['jugadores_aceptados'] ?>/<?= $row['numero_jugadores'] ?></p>
